...
export default function Navbar({ className }: NavbarProps) {
    ...
    return(
        <nav className = {cn('w-95 md:w-270 max-w-6xl h-16 bg-white flex items-center justify-between px-4 sm:px-6 md:px-8 shadow-md rounded-2xl border border-neutral-200 mr-12 relative', className)}>
            <div>
