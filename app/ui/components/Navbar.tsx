...
export default function Navbar({ className }: NavbarProps) {
    ...
    return(
        <nav className = {cn('w-200 h-16 bg-white flex items-center justify-between px-8 shadow-md rounded-2xl border border-neutral-200 mx-auto relative', className)}>
            <div>
