...
export default function GridGray({ feedback, avatar, name, work , className }: GridGrayProps){
   return(
    <div className = {cn('flex flex-col items-start justify-between p-6 bg-neutral-50 rounded-3xl gap-4 border border-neutral-300 w-full h-auto min-h-[18rem]', className)}>
